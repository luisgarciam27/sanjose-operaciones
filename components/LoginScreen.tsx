...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, isLoading, error }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!username.includes('@')) {
      alert("Ingrese su correo corporativo @sanjose.pe o el asignado por TI.");
      return;
    }
    onLogin(username);
  };
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white/80 backdrop-blur-2xl rounded-[4rem] overflow-hidden shadow-[0_40px_100px_-20px_rgba(113,75,103,0.15)] border border-white relative z-10">
        ...
        <div className="p-20 flex flex-col justify-between relative overflow-hidden" style={{ backgroundColor: ODOO_COLORS.purple }}>
          ...
          <div className="relative z-10">
             ...
             <p className="text-white/70 font-bold text-lg max-w-xs leading-snug">
                Bienvenido al portal inteligente de abastecimiento y gestión ERP.
             </p>
          </div>
          ...
          <div className="relative z-10 pt-10 border-t border-white/10 flex items-center gap-8">
             <div>
                ...
                <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mt-1 italic">Vercel Ready</p>
             </div>
        ...
        <div className="p-20 bg-white/40">
          <div className="mb-14 text-center lg:text-left">
             <h3 className="text-3xl font-black text-slate-900 tracking-tight mb-3">Acceso Seguro</h3>
             <p className="text-slate-400 font-bold text-xs uppercase tracking-[0.2em]">Identificación en la Red San José</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            {error && (
              <div className="flex gap-4 p-6 bg-red-50 border border-red-100 rounded-[2rem]">
            ...
            <div className="space-y-4">
              ...
              {isLoading && (
                <p className="text-center text-[10px] font-black text-[#714B67] uppercase tracking-[0.2em] animate-pulse">
                  Estableciendo túnel con Odoo 14...
                </p>
              )}
            </div>
          </form>
          ...
          <div className="mt-16 flex flex-col items-center">
             ...
             <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em] text-center leading-loose">
               SAN JOSÉ S.A.C.<br />
               <span className="text-indigo-300">SEGURIDAD LOGÍSTICA ACTIVA</span>
             </p>
          </div>
        </div>
      </div>
